...
public class SubtractOperationTest {
    ...
    public void subtractTest(String pol1, String pol2, String polRes) throws PolyFormatException {
        ...
        Polynomial result;
        result = operations.substractP(firstPoly, secondPoly);
        Assertions.assertEquals(resultEx, result, "Subtraction is bad");
    }

    private static List<Arguments> provideInput() {
        List<Arguments> argumentsList = new ArrayList<>();
        argumentsList.add(Arguments.of("+x^3-2x^2+6x-5", "+2x^2-1", "+x^3-4x^2+6x-4"));
        argumentsList.add(Arguments.of("+6x^3+10x^2+5", "+4x^2+2x+1", "+6x^3+6x^2+4"));
        argumentsList.add(Arguments.of("-5x", "+5x", "-10x"));
        argumentsList.add(Arguments.of("+5x+3x^2-2", "+4+2x^3-x", "-2x^3+3x^2+6x-6"));
